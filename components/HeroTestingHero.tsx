...
export default function HeroTestingHero(_props: HeroTestingHeroProps) {
      ...
      <div className={styles.overlay} ref={overlayRef}>
        ...
        <div className={styles.bottomRail}>
          ...
          <div className={styles.bottomRow}>
            ...
            <p className={styles.bottomCopy}>I build systems, AI workflows, and product strategies for real operations.
From enterprise platforms to small business teams.</p>
          </div>
        </div>
      </div>
