...
## Project metadata for PM / planning workflows
...
### Primary objective
Use this site to showcase portfolio projects and attract consulting opportunities. Emphasize real work, clear thinking, and operator-level execution.

### PM ticketing preferences
- Prefer bundled tickets over overly granular tasks
- Keep tickets implementation-ready for Codex
- Include mobile and desktop considerations for UI changes
- Keep portfolio cards concise; push full detail to project pages
- Favor minimal UI and strong hierarchy over extra explanatory copy
- Align changes with homepage-first prioritization

### Notes for PM agent
- This project prioritizes clarity, credibility, and execution over volume
